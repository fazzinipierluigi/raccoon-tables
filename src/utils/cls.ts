...
export const cls = {
  ...
  paginationPageNum:         'rt-pagination-page-num',
  paginationPageActive:      'rt-pagination-btn--active',
  paginationEllipsis:        'rt-pagination-ellipsis',
  paginationPageInput:       'rt-pagination-page-input',

  // Date picker
  datepickerWrap:            'rt-datepicker-wrap',
  datepickerInput:           'rt-datepicker-input',
  datepickerInputOpen:       'rt-datepicker-input--open',
  datepickerClear:           'rt-datepicker-clear',
  datepickerPopup:           'rt-datepicker-popup',
  dpHeader:                  'rt-dp-header',
  dpNavBtn:                  'rt-dp-nav-btn',
  dpCaption:                 'rt-dp-caption',
  dpWeekdays:                'rt-dp-weekdays',
  dpGrid:                    'rt-dp-grid',
  dpDay:                     'rt-dp-day',
  dpDayOtherMonth:           'rt-dp-day--other-month',
  dpDayToday:                'rt-dp-day--today',
  dpDaySelected:             'rt-dp-day--selected',
  dpDayFocused:              'rt-dp-day--focused',
  dpFooter:                  'rt-dp-footer',
  dpTodayBtn:                'rt-dp-today-btn',
  dpTime:                    'rt-dp-time',
  dpTimeSpinner:             'rt-dp-time-spinner',
  dpTimePart:                'rt-dp-time-part',
  dpTimeUp:                  'rt-dp-time-up',
  dpTimeDown:                 'rt-dp-time-down',
  dpTimeSep:                 'rt-dp-time-sep',
  dpConfirmBtn:              'rt-dp-confirm-btn',
